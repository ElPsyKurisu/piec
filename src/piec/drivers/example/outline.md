...
NOTES: need to tell it to do .instrument.write etc
...
NOTES: If we set a class attribute to None at the top of a specific driver, it gets skipped by the autocheck params function so you can do manual driver side handling
NOTES: 